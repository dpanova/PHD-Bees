...
acc_pca_m, precision_pca_m, recall_pca_m, misclassified_pca_m, pca_variance_m, forest_importances_pca_m = beeclass.random_forest_results(func = 'mel spec')

#%%
# RF results with MEL SPEC and NO PCA
acc_m, precision_m, recall_m, misclassified_m, forest_importances_m = beeclass.random_forest_results(func='mel spec', do_pca=False)
